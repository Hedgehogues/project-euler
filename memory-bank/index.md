...
- [specs/tasks/euler001.md](specs/tasks/euler001.md) · [specs/tasks/euler002.md](specs/tasks/euler002.md) · [specs/tasks/euler003.md](specs/tasks/euler003.md) — the applied instances of `tasks.md`'s format; linked from each `problems/euler{NNN}/README.md`
