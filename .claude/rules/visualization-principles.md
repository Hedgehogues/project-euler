...
## 8. Каждый md-файл — один приём, редиректы вместо удаления

Переименование или замена приёма оставляет старый файл заглушкой-редиректом на новый (тот же
паттерн, что у слитых файлов в этой папке), чтобы ссылки из истории не повисали.
